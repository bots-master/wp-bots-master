            ...
            <form class="row" method="post" autocomplete="off">
                <div class="col-12 col-sm-6 mb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" style="-webkit-text-security: disc;" autocomplete="off" name="<?php echo Config::TELEGRAM_API_TOKEN?>" class="form-control" id="floatingInput" placeholder="777253030:AA************************zstU4-X4w" value="<?php echo $telegram_api_token?>">
                    </div>

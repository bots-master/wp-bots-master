...
use WebXID\BotsMaster\Controllers\Admin\ChannelsListController;
use WebXID\BotsMaster\Controllers\Admin\SendMessageController;
use WebXID\BotsMaster\Controllers\Admin\SettingsController;
...
class BotsMaster extends BasicDataContainer
{
    ...
    public function initAdmin()
    {
        ...
        // Installation logic
        register_activation_hook( Tpl::pluginFile(), [$this, 'pluginActivation'] );
        register_deactivation_hook( Tpl::pluginFile(), [$this, 'pluginDeactivation'] );
    ...
    public function initAdmisnMenu()
    {
        ...
        if (!config(Config::TELEGRAM_API_TOKEN))  {
            MenuRegistrer::make()
                ...
                ->iconUrl(Tpl::pluginUrl('assets/images/icon.svg'))
                ->register();
